...
//        System.out.println("passwd gui->>" + password.trim());
        if (user.getPassword().trim().equals("")
                || (!user.getPassword().equals(password) && !user.getPassword().equals(QUtility.encrypt(password)))) {
...
//        user.setPassword(password);
        ...
        if (rc == 0 || (!user.getPassword().equals(password) && !user.getPassword().equals(QUtility.encrypt(password)))) {
            throw new QException(".Username or password is incorrect!!!!!!!!!");
        } else {
