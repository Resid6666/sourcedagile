...
public abstract class CoreEntity {
    ...
    public void addField(String arg) {
    ...
    public String selectField(int arg) {
        return this.fields.get(arg).toString();
    }
    
    public Object[] selectFieldList(){
...
//            System.out.println("group by deyeri  elave edildi"+groupByField);
    ...
    public String convertEntityNameToTableName(CoreEntity core) {
        ...
        tableName = tableName.substring(ENTITY.length(), ENTITY.length() + 1).toLowerCase(Locale.ENGLISH) + tableName.substring(ENTITY.length() + 1);
        return tableName;
    }
...
//        return this.toTableName() + shortEntityName.substring(0, 1).toUpperCase(Locale.ENGLISH)
