...
public class SessionManager {
    ...
    public static String getCurrentDomain() {
        return domainMap.getOrDefault(getCurrentThreadId(), "backlog");
    }
    ...
    /*public static boolean isInWebServiceInterval(String servicename) throws QException {
        try {
            ...
            String key = username.trim().toUpperCase(Locale.ENGLISH) + SEPERATOR + servicename.trim().toUpperCase(Locale.ENGLISH);
    ...
    public static boolean isCurrentUserModerator() throws QException {
        String userId = getCurrentUserId();
        String permissionCode = "M";
        EntityCrUser entUsr = new EntityCrUser();
        entUsr.setDeepWhere(false);
        entUsr.setDbname(getCurrentDomain());
        entUsr.setId(userId);
    ...
    public static boolean isCurrentUserCustomer() throws QException {
        String userId = getCurrentUserId();
        String permissionCode = "C";
        EntityCrUser entUsr = new EntityCrUser();
        entUsr.setDeepWhere(false);
        entUsr.setDbname(getCurrentDomain());
        entUsr.setId(userId);
    ...
    public static boolean isCurrentUserAnalyst() throws QException {
        String userId = getCurrentUserId();
        String permissionCode = "M";
        EntityCrUser entUsr = new EntityCrUser();
        entUsr.setDeepWhere(false);
    ...
    public static boolean isCurrentUserAdmin() throws QException {
        String userId = getCurrentUserId();
        String permissionCode = "A";
        EntityCrUser entUsr = new EntityCrUser();
        entUsr.setDeepWhere(false);
        entUsr.setDbname(getCurrentDomain());
        entUsr.setId(userId);
