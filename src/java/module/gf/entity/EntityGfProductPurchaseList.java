 ...
 * @author user
 */
public class EntityGfProductPurchaseList extends CoreEntity {
    ...
    public static String EMPLOYEE_USER_FULNAME = "employeeUserFulname";
    private String employeeUserFulname = "";
    ...
    public String getEmployeeUserFulname() {
        return employeeUserFulname;
    }

    public void setEmployeeUserFulname(String employeeUserFulname) {
        this.employeeUserFulname = employeeUserFulname;
    }
